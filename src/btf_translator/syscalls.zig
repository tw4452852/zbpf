...
pub const msgrcv = fn (msqid: Kernel.int, msgp: *Kernel.msgbuf, msgsz: Kernel.size_t, msgtyp: c_long, msgflg: Kernel.int) c_long;
...
pub const truncate = fn (path: *Kernel.char, length: c_long) c_long;
...
pub const ptrace = fn (request: c_long, pid: c_long, addr: c_ulong, data: c_ulong) c_long;
...
pub const io_getevents = fn (ctx_id: Kernel.aio_context_t, min_nr: c_long, nr: c_long, events: *Kernel.io_event, timeout: *Kernel.__kernel_timespec) c_long;
pub const io_submit = fn (ctx_id: Kernel.aio_context_t, nr: c_long, iocbpp: **Kernel.iocb) c_long;
...
pub const io_pgetevents = fn (ctx_id: Kernel.aio_context_t, min_nr: c_long, nr: c_long, events: *Kernel.io_event, timeout: *Kernel.__kernel_timespec, usig: *Kernel.__aio_sigset) c_long;
